...
void setup()
{
  // tell the Arduino we want the function calcInput to be called whenever INT0
  // (digital pin 2) changes from HIGH to LOW or LOW to HIGH
...
void loop()
{
 // if a new throttle signal has been measured, lets print the value to serial,
 // if not our code could carry on with some other processing
